...
#include "../changeColor2/src/changecolor.h"
...
void ChangeColor::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (ChangeColor::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&ChangeColor::colorChanged)) {
                *result = 0;
                return;
            }
        }
...
const QMetaObject ChangeColor::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_ChangeColor.data,
      qt_meta_data_ChangeColor,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};

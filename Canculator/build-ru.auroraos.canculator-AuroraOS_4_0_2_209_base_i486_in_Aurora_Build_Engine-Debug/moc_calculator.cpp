...
#include "../canculator/src/calculator.h"
...
QT_MOC_LITERAL(5, 40, 9), // "operation"
QT_MOC_LITERAL(6, 50, 4) // "text"

    },
    "Calculator\0resultChanged\0\0getNumber\0"
    "add\0operation\0text"
};
...
void Calculator::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->getNumber((*reinterpret_cast< QString(*)>(_a[1])),(*reinterpret_cast< int(*)>(_a[2]))); break;
        default: ;
        }
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Calculator::resultChanged)) {
                *result = 0;
                return;
            }
        }

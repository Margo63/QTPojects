...
QT_MOC_LITERAL(4, 23, 2), // "on"
QT_MOC_LITERAL(5, 26, 5) // "state"

    },
    "Lamp\0stateChanged\0\0off\0on\0state"
};
...
void Lamp::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (Lamp::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Lamp::stateChanged)) {
                *result = 0;
                return;
            }
        }

...
QT_MOC_LITERAL(1, 8, 17), // "visibilityChanged"
QT_MOC_LITERAL(2, 26, 0), // ""
QT_MOC_LITERAL(3, 27, 16), // "changeVisibility"
QT_MOC_LITERAL(4, 44, 9) // "isVisible"

    },
    "Changes\0visibilityChanged\0\0changeVisibility\0"
    "isVisible"
};
...
void Changes::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->changeVisibility(); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (Changes::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Changes::visibilityChanged)) {
                *result = 0;
                return;
            }
        }
        ...
        void *_v = _a[0];
        switch (_id) {
        case 0: *reinterpret_cast< bool*>(_v) = _t->getVisibility(); break;
        default: break;
        }
...
// SIGNAL 0
void Changes::visibilityChanged()
{

...
QT_MOC_LITERAL(7, 41, 1) // "y"
    ...
    "Game\0xChanged\0\0yChanged\0move\0operation\0"
    "x\0y"
};
...
void Game::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (Game::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Game::xChanged)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (Game::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Game::yChanged)) {
                *result = 1;
                return;
            }
        }

...
QT_MOC_LITERAL(3, 23, 14), // "changePosition"
QT_MOC_LITERAL(4, 38, 1), // "x"
QT_MOC_LITERAL(5, 40, 1) // "y"

    },
    "Mouse\0positionChanged\0\0changePosition\0"
    "x\0y"
};
...
void Mouse::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->changePosition((*reinterpret_cast< double(*)>(_a[1])),(*reinterpret_cast< double(*)>(_a[2]))); break;
        default: ;
        }
        ...
        {
            using _t = void (Mouse::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Mouse::positionChanged)) {
                *result = 0;
                return;
            }
        }
